...
from dataunifier.when import Not
from dataunifier.when.WhenSimpleTest import WhenSimpleTest


class TestNot(unittest.TestCase):
    def test_eq(self):
        obj1 = Not(WhenSimpleTest("true"))
        obj2 = Not(WhenSimpleTest("true"))
        self.assertTrue(obj1 == obj2)
        self.assertFalse(obj1 != obj2)

    def test_ne(self):
        obj1 = Not(WhenSimpleTest("true1"))
        obj2 = Not(WhenSimpleTest("true2"))
        self.assertFalse(obj1 == obj2)
        self.assertTrue(obj1 != obj2)

    def test_evaluate_true(self):
        obj1 = Not(WhenSimpleTest())
